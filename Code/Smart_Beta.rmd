...
ff_3_factor <- fread(paste0(data_path, "F-F_Research_Data_Factors.csv"), skip = 3) %>%
  rename(Date = V1,
         MKT = 'Mkt-RF') %>%
...
* While computing weights, we ignore stocks with negative values of factors - so their weights are set to 0
